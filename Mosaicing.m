...
figure(1), imagesc(Image1), colormap gray, axis off, axis image;
hold on;
...
figure(2), imagesc(Image2), colormap gray, axis off, axis image;
hold on;
...
X2 = cat(1,F_2(1:2,matches(1,:)),ones(1,size(matches,2)));
for ih = 1:40
...
imagesc(Image1*homographies(index));
